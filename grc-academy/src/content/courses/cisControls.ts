  ...
  modules: [
    {
      ...
      lessons: [
        { slug: 'introduction', title: 'CIS Controls en profondeur : introduction et repères', minutes: 10, content: m0l1 },
      ],
    },
    {
      ...
      lessons: [
        { slug: 'structure', title: 'La structure des CIS Controls v8 : contrôles, Safeguards et attributs', minutes: 11, content: m1l1 },
        { slug: 'controles-1-6', title: 'Les 18 contrôles (1/3) : contrôles 1 à 6 — les fondations', minutes: 12, content: m1l2 },
        { slug: 'controles-7-12', title: 'Les 18 contrôles (2/3) : contrôles 7 à 12 — le durcissement opérationnel', minutes: 12, content: m1l3 },
        { slug: 'controles-13-18', title: 'Les 18 contrôles (3/3) : contrôles 13 à 18 — détection, réponse et maturité', minutes: 12, content: m1l4 },
      ],
    },
    {
      ...
      lessons: [
        { slug: 'implementation-groups', title: 'Les Implementation Groups : le système de priorisation intégré', minutes: 12, content: m2l1 },
        { slug: 'choisir-son-ig', title: 'Choisir son Implementation Group, et la répartition par fonction de sécurité', minutes: 11, content: m2l2 },
      ],
    },
    {
      slug: 'ecosysteme-cis',
      ...
      lessons: [
        { slug: 'benchmarks', title: 'Les CIS Benchmarks : le niveau de configuration technique précise', minutes: 11, content: m3l1 },
        { slug: 'cis-ram', title: 'CIS RAM : justifier le caractère "raisonnable" des Safeguards choisis', minutes: 11, content: m3l2 },
      ],
    },
    {
      slug: 'mapping',
      ...
      lessons: [
        { slug: 'mapping', title: 'CIS Controls face aux autres référentiels étudiés dans cette plateforme', minutes: 11, content: m4l1 },
      ],
    },
    {
      ...
      lessons: [
        { slug: 'feuille-de-route', title: 'Construire une feuille de route réaliste avec les CIS Controls', minutes: 11, content: m5l1 },
      ],
    },
  ],
}
