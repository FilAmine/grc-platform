  ...
  modules: [
    {
      ...
      lessons: [
        { slug: 'introduction', title: 'RGPD en profondeur : introduction, structure et définitions clés', minutes: 10 },
      ],
    },
    {
      ...
      lessons: [
        { slug: 'champ-application', title: 'Champ d\'application matériel et territorial', minutes: 11 },
        { slug: 'bases-legales', title: 'Les six bases légales de traitement, et les catégories de données particulières', minutes: 12 },
      ],
    },
    {
      ...
      lessons: [
        { slug: 'droits-partie1', title: 'Les droits des personnes concernées (1/2) : information, accès, rectification, effacement, limitation', minutes: 12 },
        { slug: 'droits-partie2', title: 'Les droits des personnes concernées (2/2) : portabilité, opposition, décisions automatisées', minutes: 11 },
      ],
    },
    {
      ...
      lessons: [
        { slug: 'responsable-sous-traitant', title: 'Responsable de traitement, sous-traitant, et le contrat de sous-traitance', minutes: 12 },
        { slug: 'dpo', title: 'Le Délégué à la Protection des Données (DPO)', minutes: 10 },
      ],
    },
    {
      ...
      lessons: [
        { slug: 'securite-violations', title: 'Sécurité du traitement et notification des violations de données', minutes: 12 },
        { slug: 'registre-aipd', title: 'Le registre des traitements et l\'analyse d\'impact (AIPD/DPIA)', minutes: 12 },
      ],
    },
    {
      ...
      lessons: [
        { slug: 'transferts-internationaux', title: 'Les transferts internationaux de données', minutes: 12 },
      ],
    },
    {
      ...
      lessons: [
        { slug: 'autorites-guichet-unique', title: 'Les autorités de contrôle, le guichet unique et le Comité européen', minutes: 11 },
        { slug: 'sanctions', title: 'Sanctions administratives, responsabilité civile et recours collectifs', minutes: 11 },
      ],
    },
    {
      ...
      lessons: [
        { slug: 'feuille-de-route', title: 'Construire un programme de conformité RGPD réaliste', minutes: 10 },
      ],
    },
  ],
}
