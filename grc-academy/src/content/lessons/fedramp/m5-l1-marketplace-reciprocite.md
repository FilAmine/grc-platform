...
## Un exemple concret de fiche du Marketplace

Une agence consultant le FedRAMP Marketplace pour un besoin d'hébergement cloud générique y trouverait, par exemple, des offres telles qu'**AWS GovCloud (US)** et **Microsoft Azure Government** — des régions cloud dédiées et physiquement isolées des régions commerciales standard de chaque fournisseur, opérées par du personnel américain habilité et autorisées au niveau d'impact Élevé développé au module 1 de ce parcours, aux côtés d'offres autorisées au niveau Modéré directement dans les régions cloud commerciales standard de ces mêmes fournisseurs. Chaque fiche précise la voie d'autorisation empruntée (Agence ou FedRAMP Board), la ou les agences ayant déjà adopté l'autorisation par réciprocité, et la date de la dernière surveillance continue documentée — permettant à une nouvelle agence intéressée de comparer en quelques minutes plusieurs offres déjà autorisées plutôt que d'engager sa propre évaluation de zéro.
